...
public class Swagger2Config {
    public static String SYS_NAME = "低代码API生成服务Demo";
    ...
    private ApiInfo apiInfo(String sysName,String version) {
        ApiInfo apiInfo = new ApiInfoBuilder()
                ...
                .contact(new Contact("admin", "http://127.0.0.1:8090/doc.html","admin@admin.com"))
    ...
    public Docket createAPI() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .pathMapping("/")
                .groupName("Web端业务API文档"+DEFAULT_VERSION)
                .select()
                .apis(RequestHandlerSelectors.basePackage("io.github.wujun728.web.server.controller"))
