...
/**
 * 貌似如果代码有lambda表达式，那 offset += CONSTANT_ITEM_LENGTH[tag]; 会数组越界
 * <pre>
 *     java.lang.ArrayIndexOutOfBoundsException: 18
 * 	at com.ibeetl.olexec.execute.ClassModifier.modifyUTF8Constant(ClassModifier.java:71)
 * 	at com.ibeetl.olexec.execute.JavaClassExecutor.execute(JavaClassExecutor.java:73)
 * </pre>
 *
 */
