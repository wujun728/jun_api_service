package com.ibeetl.olexec.compile;
...
public class StringSourceCompilerExtend {
    ...
    protected String getClassPath(){
        ...
        try{
            libPath = BeetlUtil.getWebRoot() + File.separator+"WEB-INF/lib";
            if(!new File(libPath).exists()){
                return null;
            }else{
                List<String> libPathList =  new ArrayList<String>();
                String classesPath = BeetlUtil.getWebRoot() + File.separator+"WEB-INF/classes";
