...
import com.ibeetl.olexec.OnlineExecutorApplication;
...
@SpringBootTest(classes = OnlineExecutorApplication.class)
...
//        }.start();
        ...
        String res = executeStringSourceService.execute(lombokSource, systemIn1);
        System.out.println("---------- Begin ----------");
